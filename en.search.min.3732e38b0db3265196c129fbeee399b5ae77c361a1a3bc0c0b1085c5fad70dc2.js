...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/sparql-cheatsheet/flexsearch.min.js');loadScript('/sparql-cheatsheet/en.search-data.min.518711b9e79f07cbefe08ad65a945ad7a8eba079ea5f3117da7671f81a40b2ef.js',function(){input.required=false;search();});}
